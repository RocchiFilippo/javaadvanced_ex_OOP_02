...
public class Exercises {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(4, "Quattro");
        myFirstMap.put(7, "Sette");
    ...
    private static void exercise2() {
        ...
        // Your code
        double currentHigherPrice = Double.MIN_VALUE;
        for(Map.Entry<String, Double> entry : menuCostsInEuro.entrySet()){
            if (entry.getValue() > currentHigherPrice)
            {
                mostExpensiveMenuItemName = entry.getKey();
                currentHigherPrice = entry.getValue();
            }
        }
    ...
    private static void exercise3() {
        ...
        // Your code
        for (Integer fruitWeight : fruitWeights.values()){
